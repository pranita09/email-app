  ...
  return(
    <>
      ...
      <fieldset>
        ...
        <label><input type='checkbox' onChange={()=> dispatch({type: 'unread_filter'})}/>Show unread mails</label>
        <label><input type='checkbox' onChange={()=> dispatch({type: 'star_filter'})} />Show starred mails</label>
      </fieldset>
      <ul>
        {
