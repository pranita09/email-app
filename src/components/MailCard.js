  ...
  return (
    <>
      <li>
        <div className="space-between">
          ...
          <span>
            {!trashAdded && !spamAdded && (
              <button
                onClick={() => dispatch({ type: "STAR_TOGGLE", payload: mId })}
              >
        ...
        <p>{content}</p>
        <div className="space-between">
          <NavLink className="navlink" to={`/email/${mId}`}>
            View details
          </NavLink>
          <div className="end-buttons">
            {!trashAdded && !spamAdded && (
              <>
                ...
                <button
                  ...
                  onClick={() =>
                    dispatch({ type: "UNREAD_TOGGLE", payload: mId })
                  }
                >
            ...
            {trashAdded && (
              <button
                style={{ color: "green" }}
                onClick={() =>
                  dispatch({ type: "TRASH_RESTORE", payload: mail })
                }
              >
                Restore
              </button>
            ...
            {spamAdded && (
              <button
                style={{ color: "green" }}
                onClick={() =>
                  dispatch({ type: "SPAM_RESTORE", payload: mail })
                }
              >
                Remove from Spam
              </button>
